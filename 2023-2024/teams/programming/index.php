			...
			<div class="card flex-basis-auto flex-basis-sm-40rem m-3 m-md-0">
				<div class="card-body">
					...
					<div class="d-flex gap-3 mt-4">
						<div><i class="fa-duotone fa-box fa-3x text-secondary fa-fw"></i></div>
						<div>
							<div><a href="https://github.com/FIRST-Tech-Challenge/FtcRobotController/tree/master" target="_blank">FtcRobotController repository</a></div>
							<div class="small text-secondary">This repository contains the code for the FTC Robot Controller app. Version 9 is the official version for CenterStage in 2023-2024.</div>
						</div>
					</div>
					<div class="d-flex gap-3 mt-4">
