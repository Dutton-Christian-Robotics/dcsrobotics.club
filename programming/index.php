			...
			<div class="card flex-basis-auto flex-basis-sm-30rem m-3 m-md-0">
				<div class="card-body">
					...
					<div class="d-flex gap-3 mt-4">
						...
						<div>
							<div><a href="https://www.firstinspires.org/sites/default/files/uploads/resource_library/ftc/onbot-java-guide.pdf" target="_blank">OnBot Java Guide</a></div>
					...
					<div class="d-flex gap-3 mt-4">
						<div><i class="fa-duotone fa-compass fa-3x text-secondary fa-fw"></i></div>
						<div>
							<div><a href="https://www.firstinspires.org/sites/default/files/uploads/resource_library/ftc/android-studio-guide.pdf" target="_blank">Android Studio Guide</a></div>
