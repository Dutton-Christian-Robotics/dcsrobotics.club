	...
	<body>
		...
		<div class="p-3 p-md-5 mt-0 d-flex gap-3 flex-column flex-sm-row justify-content-sm-center align-items-start">
				...
				<table class="mt-md-3">
					<tbody class="text-white fs-5 align-text-top">
						...
						<tr>
							...
							<td class="p-2">four wheel drive, powered by four NeveRest Classic 40 motors</td>
						</tr>
						<tr>
							<td class="p-2 ps-0"><span class="badge bg-dark">Intake</span></td>
							<td class="p-2">Two-wheeled surgical tubing and rubber band paddle wheel, powered by a REV Core Hex motor</td>
						</tr>
						<tr>
							<td class="p-2 ps-0"><span class="badge bg-dark">Extension</span></td>
							<td class="p-2">linear slide with string pulleys, powered by a REV Core Hex motor</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="p-2 ps-0"><span class="badge bg-dark">Dropoff</span></td>
							<td class="p-2">metal box with servo-actuated tilt mechanism</td>
						</tr>
			...
			<div class="d-flex flex-basis-sm-20rem p-2 flex-column bg-white align-items-center">				
				<img src="/images/photos_gulllake19/picture_007.jpg" class="w-100"/>
			</div>
