	...
	<body>
		...
		<div class="position-relative h-20rem">
			...
			<div class="position-absolute start-0 end-0 text-white text-center" style="bottom:1rem;">
				<h1 class="display-3 mb-0 pb-0 text-shadow-3">DCS Defenders Robotics</h1>
		...
		<div class="mt-5 mb-5 d-flex justify-content-center gap-5 flex-column flex-sm-row align-items-center">
			<div class="card bg-warning text-white">
				<div class="card-body d-flex flex-column align-items-center">
					...
					<h4 class="card-title fw-bold mb-0 pb-0 text-dark">Follow Us</h4>
					<h5 class="card-title mt-0 pt-0 text-dark">on social media</h5>
				</div>
			</div>
