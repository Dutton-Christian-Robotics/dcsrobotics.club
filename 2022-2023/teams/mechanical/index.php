		...
		<div class="d-flex mt-5 gap-3 flex-column flex-md-row align-items-md-start justify-content-md-center">
			...
			<div class="card flex-basis-auto flex-basis-sm-40rem m-3 m-md-0">
				<div class="card-body p-lg-4">
					...
					<h3 class="card-title fw-bold">Miscellaneous</h3>
					...
					<div class="d-flex gap-3 mt-4">
						...
						<div>
							...
							<div class="small text-secondary">A presentation from "The Bionic Tigers", team 10464, that discusses the diferent types of robot drivetrains that commonly appear in FTC robots.</div>
						</div>
					</div>
